...
expert_lens: "Ulrich Bindseil | Salih Neftci"
provenance: Ulrich Bindseil - Central Bank Operations (2014) & Neftci (2008)
thesis: Cross-Currency Basis là mức chênh lệch lãi suất (spread) cộng thêm vào chân
  ngoại tệ trong một giao dịch hoán đổi tiền tệ, phản ánh sự lệch pha giữa lý thuyết
  Covered Interest Parity (CIP) và thực tế thị trường do các rào cản về quy định,
  thanh khoản và nhu cầu phòng vệ.
source_refs:
...
---
## 4. Historical Context: March 2020 & Forced Liquidation
[WIKI] Trong đại dịch COVID-19, XCCY Basis của JPY/USD và EUR/USD đã sụt giảm mạnh (âm sâu). Khi Basis âm quá sâu, chi phí phòng vệ trở nên đắt đỏ đến mức các NHTW nước ngoài buộc phải bán tháo **US Treasuries** để lấy USD mặt phục vụ nhu cầu trong nước. 

Việc Fed kích hoạt các đường dây hoán đổi ([[Central_Bank_Swap_Lines]]) không chỉ giúp kéo Basis trở lại mức cân bằng mà còn là công cụ then chốt để **ngăn chặn sự sụp đổ của thị trường Trái phiếu Chính phủ Mỹ** do áp lực bán tháo từ bên ngoài. [RAW-CLIP: Goghie]
...
- Swap lines as UST market stabilizers: [[I_need_a_dollar_through_your_swap_line.md]]
