...
| **10Y real yield / breakeven (Jul 2)** | **2.26% / 2.23%** — real yield tăng +32bp, breakeven đi ngang cả H1 [RAW-OFFICIAL: Treasury.gov real yield curve] |
...
**Mức tin cậy: TIER B+** — Bảng cân đối Treasury (debt outstanding, WAM, coupon rates), refunding details (Q1+Q2), TIC foreign holdings, yield curve daily trajectory (nominal + real/TIPS, biweekly H1 2026), và ACM term premium đều đã ingest từ nguồn RAW-OFFICIAL (Treasury.gov trực tiếp cho phần lớn) hoặc WEB có timestamp. Gap còn lại: official T10YIE breakeven series (đang dùng nominal−real approximation, không phải methodology chính thức); 5Y5Y forward breakeven; NY Fed ACM daily timeseries đầy đủ (chỉ có 3 điểm tháng 4-5).
...
8. **NEW** — Ingest NY Fed ACM daily timeseries đầy đủ H1 2026 (hiện chỉ có 3 điểm rời rạc: Apr30/May15/May28, thiếu June-July) để xác nhận ACM term premium có đồng pha với real yield tăng hay không
9. **NEW** — Official T10YIE (FRED) hoặc 5Y5Y forward breakeven để thay thế phép tính xấp xỉ nominal−real hiện tại
