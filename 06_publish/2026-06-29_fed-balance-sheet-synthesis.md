...
| **Balance Sheet** | Total assets $6,735.6B phẳng: UST $4,488.1B (Bills $486B / Notes-Bonds $3,615B / TIPS $279B) / MBS $1,961.6B [RAW-OFFICIAL: H.4.1 24/06/2026] |
...
|--|------|-----------------|--------|
| **Regime** | QE: +$3.3T reserves, WAM kéo dài; QT2: −$2.2T, ON RRP làm đệm → reserves ổn định | RMP phẳng; reserves $2,951B = floor; ON RRP $2.3B = 0; WAM ~7.24 năm [RAW-OFFICIAL: H.4.1 maturity buckets calc] | Phẳng trừ crisis; WAM rút ngắn nếu Warsh bills-only; term premium nới nếu không mở rộng portfolio |
...
| **Confidence** | TIER B — stock data sourced (H.4.1); flow H1 2026 nay RAW-OFFICIAL (11-điểm weekly series, xem `2026-07-02_fed-balance-sheet-flow-mechanics-h1-2026.md`); WAM confirmed 7.24yr; deferred asset vẫn [LLM-E] |
...
```bash
# Data gaps ưu tiên — RESOLVED 2026-07-02 (xem flow-mechanics doc)
# ✓ Weekly H.4.1 reserves/TGA/RRP flow series (11 điểm Jan-Jun 2026)
# ✓ Treasury auction BTC (notes+bonds đầy đủ H1 2026)
# ✓ SOFR–IORB monthly H1 2026 (daily chỉ có tháng 6)
# ~ ACM term premium — có Apr/May, THIẾU tháng 6
# → Vẫn thiếu: currency-in-circulation weekly (đóng identity đầy đủ), bills auction data,
#   H.4.1 maturity schedule chi tiết hơn (đã có WAM tổng 7.24yr)

# Cập nhật quan trọng từ chuỗi flow thực nghiệm (xem 06_publish/2026-07-02_fed-balance-sheet-flow-mechanics-h1-2026.md, 23 điểm):
# - Sàn "$3,000B" trong MACRO/PLUMBING layer ở trên nên đọc là ƯỚC TÍNH BIÊN TRÊN — đáy reserves
#   thực nghiệm H1 2026 là $2,901.8B (22/04/2026, mùa quyết toán thuế) và KHÔNG kích hoạt SOFR-IORB stress.
# - Cửa sổ 08/04→22/04: TGA +$310.1B/2 tuần, reserves -$214.4B — biên TGA thật RỘNG HƠN ước tính
#   "$100-200B/tuần" ban đầu; đây là thí nghiệm tự nhiên khép kín xác nhận identity ΔReserves≈RMP-ΔTGA.
# - RMP pace ~$40B/tháng [LLM-E] nay CONFIRMED RAW-OFFICIAL ở +$42B/tháng UST net.
# - MBS runoff pace ~$15-20B/tháng [LLM-E] nay đo được RAW-OFFICIAL ~$14B/tháng (thấp hơn ước tính).
# - Bills 13-26 tuần cho thấy mềm nhẹ (BTC giảm ~30-50bp Jan-Feb→June) — đúng vị trí TBAC cảnh báo
#   bills vượt target 15-20% danh mục nợ khả mại; notes/bonds (BTC 2.30-2.99) không suy yếu.

# Nodes đã tạo/cập nhật
...
# ✓ 06_publish/2026-07-02_fed-balance-sheet-flow-mechanics-h1-2026.md (flow layer đầy đủ)
# updated: 03_wiki/mechanisms/Reserve_Management_Purchases_RMP.md
# updated: 03_wiki/mechanisms/Payment_System_Floor_On_Fed_Balance_Sheet.md
